...
export default function Faqs() {
  return (
    <div className="f">
      ...
      <div><Faq question="What content is available on *****" num={2} open={false}>
      ...
      <div><Faq question="What are the subscription plans?" num={4} open={false}>
        **********************
      </Faq></div>
      <div><Faq question="How do I resolve my queries?" num={5} open={false}>
